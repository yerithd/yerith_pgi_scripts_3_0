...
gdbus call --session --dest org.freedesktop.DBus --object-path \
	/org/freedesktop/DBus --method org.freedesktop.DBus.UpdateActivationEnvironment '{"GTK_OVERLAY_SCROLLING": "0"}'
...
YERITH_ERP_3_0_HOME_FOLDER=${HOME}/yerith-erp-3-0

YERITH_ERP_3_0_PROPERTIES_CONFIGURATION_FOLDER=${YERITH_ERP_3_0_HOME_FOLDER}

YERITH_ERP_3_0_SYSTEM_DAEMON_HOME_FOLDER=$HOME/yerith-erp-3-0-system-daemon

YR_DB_RUNTIME_VERIF_HOME_FOLDER=/opt/yri-db-runtime-verif
...
export YERITH_ERP_3_0_pgi_scripts="${HOME}"/yerith_pgi_scripts_3_0

export YR_DB_RUNTIME_VERIF_HOME_FOLDER=/opt/yri-db-runtime-verif

PATH=/sbin:/usr/sbin:${PATH}

PATH=/usr/lib/git-core:${PATH}

PATH=${YERITH_ERP_3_0_HOME_FOLDER}/yerith-erp-3-0-development-scripts:${PATH}

PATH=${YERITH_ERP_3_0_HOME_FOLDER}/yerith-erp-3-0-development-scripts/ENGLISH:${PATH}
...
if [ -x /usr/bin/dircolors ]; then
    ...
    alias ls='dir'
    LS_OPTIONS="--file-type --color=auto"
